export const WC2026_SQUADS_TEXT = `
GROUP A
...
Türkiye
Preliminary roster announced on May 18

Goalkeepers: Ugurcan Cakir (Galatasaray), Mert Gunok (Fenerbahce), Altay Bayindir (Man United), Muhammed Sengezer (Istanbul Basaksehir), Ersin Destanoglou (Besiktas)

Defenders: Merih Demiral (Al-Ahli), Zeki Celik (AS Roma), Caglar Soyuncu (Fenerbahce), Mert Muldur (Fenerbahce), Ferdi Kadioglu (Brighton & Hove Albion), Ozan Kabak (TSG Hoffenheim), Abdulkerim Bardakci (Galatasaray), Eren Elmali (Galatasaray), Samet Akaydin (Caykur Rizesport), Mustafa Eskihellac (Trabzonspor), Yusuf Akcicek (Al-Hilal), Ahmetcan Kaplan (NEC Nijmegen)

Midfielders: Hakan Calhanoglu (Inter Milan), Kaan Ayhan (Galatasaray), Orkun Kokcu (Besiktas), Ismail Yuksek (Fenerbahce), Salih Ozcan (Borussia Dortmund), Atakan Karazor (VfB Stuttgart), Demir Ege Tiknaz (Besiktas)

Forwards: Kerem Akturkoglu (Fenerbahce), Irfan Can Kahveci (Kasimpasa), Baris Apler Yilmaz (Galatasaray), Arda Guler (Real Madrid), Kenan Yildiz (Juventus), Yunus Akgun (Galatasaray), Oguz Aydin (Fenerbahce), Deniz Gul (Porto), Yusuf Sari (Basaksehir), Can Uzun (Eintracht Frankfurt), Aral Simsir (Midtjylland)
...
Iran
Provisional roster announced on May 18
...
Defenders: Danial Eiri (Malavan), Ehsan Hajsafi (Sepahan), Saleh Hardani (Esteghlal), Hossein Kanaani (Persepolis), Shoka Khalilzadeh (Tractor), Milad Mohammadi (Persepolis), Ali Nemati (Foolad), Omid Noorafkan (Foolad), Ramin Rezaeian (Foolad)
...
Senegal
Provisional roster announced on May 21

Goalkeepers: Édouard Mendy (Al Ahli), Mory Diaw (Le Havre AC), Yehvann Diouf (OGC Nice)

Defenders: Krépin Diatta (AS Monaco), Antoine Mendy (OGC Nice), Kalidou Koulibaly (Al Hilal), El Hadji Malick Diouf (West Ham United), Mamadou Sarr (Chelsea), Moussa Niakhaté (Lyon), Moustapha Mbow (Paris FC), Abdoulaye Seck (Maccabi Haifa), Ismail Jakobs (Galatasaray), Ilay Camara (Anderlecht)
...
Forwards: Kamaldeen Sulemana (Atalanta), Christopher Bonsu Baah (Al Qadsiah), Ernest Nuamah (Lyon), Antoine Semenyo (Manchester City), Brandon Thomas-Asante (Coventry City), Prince Kwabena Adu (Viktoria Plzen), Iñaki Williams (Athletic Bilbao), Jordan Ayew (Leicester City)
